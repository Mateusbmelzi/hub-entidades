...
const TermosModal: React.FC<TermosModalProps> = ({ isOpen, onClose, onAccept }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="p-0 modal-terms-mobile">
        <DialogHeader className="p-4 sm:p-6 pb-3 sm:pb-4 border-b">
          <DialogTitle className="flex items-center gap-2 text-lg sm:text-xl">
            <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-insper-red" />
            Termos de Uso e Política de Privacidade
          </DialogTitle>
          <p className="text-xs sm:text-sm text-insper-dark-gray">
            Leia atentamente os termos antes de prosseguir com o cadastro
          </p>
        </DialogHeader>

        <ScrollArea className="h-[50vh] sm:h-[60vh] p-4 sm:p-6">
          <div className="space-y-4 sm:space-y-6">
            {/* Quem Somos */}
            <section>
              <h2 className="text-base sm:text-lg font-semibold text-insper-black mb-2 sm:mb-3 flex items-center gap-2">
                <Shield className="w-3 h-3 sm:w-4 sm:h-4" />
                Quem Somos?
              </h2>
              <p className="text-insper-dark-gray leading-relaxed mb-3 sm:mb-4 text-xs sm:text-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
                <div className="bg-insper-light-gray p-2 sm:p-3 rounded-lg">
                  <h3 className="font-semibold text-insper-black mb-1 flex items-center gap-2 text-xs sm:text-sm">
              ...
              <div className="bg-insper-red/5 border border-insper-red/20 p-2 sm:p-3 rounded-lg">
                <p className="text-xs text-insper-dark-gray">
            ...
            <section>
              ...
              <p className="text-insper-dark-gray leading-relaxed mb-2 sm:mb-3 text-xs sm:text-sm">
              ...
              <ul className="space-y-1 mb-2 sm:mb-3">
                <li className="flex items-start gap-2">
                  <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-insper-red rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
              ...
              <div className="bg-blue-50 border border-blue-200 p-2 sm:p-3 rounded-lg mb-2 sm:mb-3">
                <h3 className="font-semibold text-insper-black mb-1 text-xs sm:text-sm">Uso dos Dados</h3>
                <p className="text-xs text-insper-dark-gray mb-1 sm:mb-2">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 gap-1 sm:gap-2">
                <div className="flex items-center gap-2">
                  <Check className="w-2 h-2 sm:w-3 sm:h-3 text-insper-red" />
            ...
            <section>
              ...
              <p className="text-xs sm:text-sm text-insper-dark-gray mb-1 sm:mb-2">
                Para exercer seus direitos ou esclarecer dúvidas:
              </p>
              <div className="bg-insper-light-gray p-2 sm:p-3 rounded-lg">
                <p className="text-xs sm:text-sm font-medium text-insper-black">mateusbm@al.insper.edu.br</p>
        ...
        <div className="p-4 sm:p-6 border-t bg-insper-light-gray">
          <div className="flex items-start space-x-2 sm:space-x-3 mb-3 sm:mb-4">
            <Checkbox
              ...
              className="mt-0.5"
            />
            <Label htmlFor="accept-terms" className="text-xs sm:text-sm text-insper-dark-gray leading-relaxed">
          ...
          <div className="flex gap-2 sm:gap-3">
            ...
            <Button
              ...
              className="flex-1 bg-insper-red hover:bg-insper-red/90 button-mobile"
            >
